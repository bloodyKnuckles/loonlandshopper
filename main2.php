...
<table width="100%" cellspacing="0" cellpadding="4" align="center"
 border="0">
  <tr>
    <td style="font-size: x-small;">Want a trial run? Use the Quick Ad form below to send a "no signup" ad to the moderator for approval. When you want to add photos, edit and relist your ads, sign up for an account!</td>
  </tr>
</table>
...
<table width="100%" cellspacing="0" cellpadding="4" border="0">
  <tr>
    <td align="right" valign="top">Your Ad:</td>
    <td><span style="font-size: x-small; color: #666666;">Who what when where how why? Be sure to include how you want people to contact you.</span><br>
        <input type="text" name="description" value="" size="80">
    </td>
  </tr>
  <tr>
    <td align="right" valign="top">Classifications:</td>
    <td><span style="font-size: x-small; color: #666666;">Hold down the control (Win) / command (Mac) button to select multiple options</span><br>
  ...
  <tr>
    ...
    <td><!-- span style="font-size: x-small; color: #666666;">.</span><br -->
